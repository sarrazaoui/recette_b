...
export default function ModifierRecetteAdmin() {
  return (
    <>
            ...
            <div className="row">
              <div className="col-12">
                <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 className="mb-sm-0">Modifier recette</h4>
                </div>
              </div>
            </div>
            {/* End page title */}
                      ...
                      <div className="row mt-3">
                        ...
                        <div className="hstack gap-2 justify-content-end d-print-none mt-4">
                          <button
                            ...
                            onClick={() =>
                              (window.location.href = "ConsulterRecetteAdmin")
                            }
                          >
                          ...
                          <button type="submit" className="btn btn-warning">
                            <i className="ri-edit-fill align-bottom me-1" />
                            Modifier
                          </button>
                        </div>
                      </div>
