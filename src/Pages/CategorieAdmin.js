            ...
            <div className="row">
              <div className="col-12">
                <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 className="mb-sm-0">Catégorie</h4>
                </div>
              </div>
            </div>
            {/* end page title */}
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      <div>
                        <h5 className="fs-15 text">
                          <a href="SousCategorieAdmin" className="text-dark">
                            Végétariens
                          </a>
                        </h5>
                        <div className="avatar-lg bg-light rounded p-1">
                          <img
                            src="assets/images/catvége.png"
                            alt=""
                                ...
                                <div className="card-body pt-2">
                                  <div className="dropzone">
                                    ...
                                    <div style={{ textAlign: "center" }}>
                                      ...
                                      <h6>
                                        enter une nouvelle image de la catégorie
                                      </h6>
                                    </div>
                                  </div>
                                </div>
                ...
                <div className="sticky-side-div">
                  <div className="card">
                    <div className="card-header border-bottom-dashed">
                      <h5 className="card-title mb-0">Ajouter catégorie</h5>
                    </div>
